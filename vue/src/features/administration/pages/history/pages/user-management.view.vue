...
const { t, response, options, loading, tableColumns, getPaginatedData } = useActivitiesTable(Domain.USER_MANAGEMENT)
...
<template>
  <ContentLayout
    ...
    subtitle="administration.activity-logs.user-management.subtitle"
  >
    <template #table>
