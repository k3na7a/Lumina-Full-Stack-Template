...
import { Action, Domain } from '@lib/dto/audit.dto.ts'

const { t, response, options, loading, tableColumns, getPaginatedData } = useActivitiesTable(Domain.GAMES_AND_SOFTWARE)
...
<template>
  <ContentLayout
    title="administration.activity-logs.games-and-software.title"
    subtitle="administration.activity-logs.games-and-software.subtitle"
  >
    <template #table>
