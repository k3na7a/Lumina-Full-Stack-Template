...
import ModalTitle from '@/shared/components/modal/modal-title.component.vue'
</script>
...
<template>
  <div class="d-flex flex-column gap-3">
    ...
    <div class="d-flex flex-column gap-1">
      ...
      <slot name="release_date"></slot>
    </div>

    <div class="d-flex flex-column gap-1">
      <h6 class="fw-semibold">{{ $t('forms.description') }}</h6>
      <slot name="description"></slot>
    </div>

    <div class="d-flex flex-column gap-1">
      <h6 class="fw-semibold">{{ $t('administration.games-and-software.platforms.label') }}</h6>
