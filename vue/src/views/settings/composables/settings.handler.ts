...
import UploadImageModal from '@/shared/components/modal/image-upload.modal.vue'
import ConfirmModal from '@/shared/components/modal/confirm.modal.vue'
import PasswordModal from '@/shared/components/modal/password.modal.vue'
