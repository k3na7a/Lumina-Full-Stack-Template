...
import { ROUTE_NAMES } from '@/core/router/routes.ts'

import { useFormUtil } from '@/core/utilities/forms.util.ts'
import { ForgotPassword } from '@/core/apis/dto/user.dto.ts'

import { useGuestHandler } from '@/shared/layouts/guest/handlers/guest.handler.ts'
...
const { t } = useI18n()
const handler = useGuestHandler(t)
