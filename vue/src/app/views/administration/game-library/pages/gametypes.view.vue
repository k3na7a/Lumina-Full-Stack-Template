...
const sort: Array<SortOptions> = [
  ...
  { sort: 'gametype.name', order: Order.ASC, label: 'forms.name' }
]
...
<template>
  <TablePaginated
    ...
    :caption="
      t('administration.game-library.gametypes.caption', { showing: response.data.length }, response.meta.itemCount)
    "
  >
    <template v-slot>
      <button
