      ...
      <template v-if="!state.open">
        <div class="d-flex flex-grow-1">
          <div class="d-flex flex-column flex-grow-1 pe-2 overflow-hidden">
            ...
            <p class="fw-normal text-muted">This email is linked to your account.</p>
          </div>
        ...
        <div class="d-flex flex-column flex-grow-1">
          <div class="row gy-2 align-items-start flex-grow-1 mb-2">
            <div class="col-12 col-md-6">
              ...
              <small class="text-muted">New Email Address</small>
            </div>
            <div class="col-12 col-md-6">
              <TextInput class="mb-1" name="confirm_email" type="text" />
              <small class="text-muted">Confirm New Email Address</small>
            </div>
          </div>
