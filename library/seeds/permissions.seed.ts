...
export const PERMISSIONS_SEED: PermissionSeed[] = [
  // SYSTEM
  {
    ...
    description: 'Grants unrestricted access to all actions across the system, bypassing normal checks.',
  ...
  {
    key: FrontEndPermissions.MANAGE_PERMISSIONS,
    label: 'Manage Permissions',
    description: 'Allows the user to access the permissions section of the admin panel and manage permissions.',
    domain: PermissionDomain.FRONT_END
  },
  {
    key: FrontEndPermissions.MANAGE_ROLES,
    label: 'Manage Roles',
    description: 'Allows the user to access the roles section of the admin panel and manage roles.',
    domain: PermissionDomain.FRONT_END
  },
  {
    key: FrontEndPermissions.MANAGE_USERS,
    label: 'Manage Users',
    description: 'Allows the user to access the users section of the admin panel and manage users.',
    domain: PermissionDomain.FRONT_END
  },
  {
    key: FrontEndPermissions.MANAGE_GAMES,
    label: 'Manage Games',
    description: 'Allows the user to access the games section of the admin panel and manage games.',
    domain: PermissionDomain.FRONT_END
  },
  {
    key: FrontEndPermissions.MANAGE_PLATFORMS,
    label: 'Manage Platforms',
    description: 'Allows the user to access the platforms section of the admin panel and manage platforms.',
    domain: PermissionDomain.FRONT_END
  },
  {
    key: FrontEndPermissions.VIEW_AUDIT,
    label: 'View Audit Logs',
    description: 'Allows the user to access the audit log section of the admin panel.',
    domain: PermissionDomain.FRONT_END
  },
